...
describe("MilitaryTime function", function() {
  it("should convert a 12 hour time to 24 hour", function () {
    expect(MilitaryTime(["8:00", "AM"])).toEqual("09:00");
    expect(MilitaryTime(["12:30", "PM"])).toEqual("13:30");
    expect(MilitaryTime(["3:30", "PM"])).toEqual("16:30");
    expect(MilitaryTime(["12:45", "AM"])).toEqual("01:45");
  });
});
